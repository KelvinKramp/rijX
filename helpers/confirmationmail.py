confirmationpart1 = """<!DOCTYPE html>
<html>
<head>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Klik op onderstaande knop om online te betalen </p>
            </td>
          </tr>
          <!-- end copy -->
...
confirmationpart2 = """ " target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Online betalen</a>
                        </td>
                      </tr>
                    </table>
                  </td>
...
if __name__ == '__main__':
    print(confirmationpart1 + "https://tikkie.me/pay/RijRdam/bAFvY84bg74J6XioYMnKk" + confirmationpart2)